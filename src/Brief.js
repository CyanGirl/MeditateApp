  ...
  return (
    <div id="brief">
      ...
      <p>
        ...
        and awareness. <br />
        Mindfulness and Awareness Trainings use conscious breathing for training
        awareness and body consciousness <br /> <br />
      </p>
      <br />
      <p>
        Consciously changing the way you breathe appears to send a signal to the
        brain to adjust the parasympathetic branch of the nervous system, which
        can slow heart rate and digestion and promote feelings of calm as well
        as the sympathetic system, which controls the release of stress hormones
        like cortisol.
      </p>
      <p>
        The 4-7-8 breathing technique, also known as “relaxing breath,” involves
        breathing in for 4 seconds, holding the breath for 7 seconds, and
        exhaling for 8 seconds. This breathing pattern aims to reduce anxiety or
        help people get to sleep. Some proponents claim that the method helps
        people get to sleep in 1 minute.
      </p>
      <br />
      <p>
